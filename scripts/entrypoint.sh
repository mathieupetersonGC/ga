...
grep -q 'passwordIsEncrypted' /etc/HelpSystems/GoAnywhere/config/database.xml || sed -i "s|</properties>|<entry key=\"passwordIsEncrypted\">true</entry>\n</properties>|g" /etc/HelpSystems/GoAnywhere/config/database.xml
